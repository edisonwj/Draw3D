...
* 
*/
public class TestRoomScanRandom extends Application {
	private Draw3D dt;
	...
	public void start(Stage primaryStage) {
		...
		primaryStage.setTitle("TestRoomScanRandom");
		primaryStage.show();
	}
	...
	private void buildData() {
		...
		cameraShortList.add(createCamera(exWalls, inWalls));
		for (int ci = 0; ci < 50; ci++) {
			drawWallsGrid(0, hiboundX, 0, hiboundY, exWalls, inWalls);
			RoomCamera camera = createCamera(exWalls, inWalls);
