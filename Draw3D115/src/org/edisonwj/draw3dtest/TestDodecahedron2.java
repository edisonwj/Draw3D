...
* 
*/
public class TestDodecahedron2 extends Application {
	private Draw3D dt;
	double os = 1;
	double xrinit = 45;
	double yrinit = 45;
	...
	public void start(Stage primaryStage) {
		...
		primaryStage.setTitle("TestDodecahedron2");
		primaryStage.show();
	}
	...
	private void buildData() {
		...
		dt.setSequencingOn();
/*	
		Dodecahedron3D t3d10 = new Dodecahedron3D(-6, 0, 0, os, 0, 0, 0, blueMaterial);
		t3d10.setDrawMode(DrawMode.FILL);
		dt.drawPolyhedron3D(t3d10,  true);
		
		Dodecahedron3D t3d11 = new Dodecahedron3D( -2, 0, 0, os, 45, 0, 0, blueMaterial);
		t3d11.setDrawMode(DrawMode.FILL);
		dt.drawPolyhedron3D(t3d11, true);
		
		Dodecahedron3D t3d12 = new Dodecahedron3D( 2, 0, 0, os, 0, 45, 0, blueMaterial);
		t3d12.setDrawMode(DrawMode.FILL);
		dt.drawPolyhedron3D(t3d12, true);
		
		Dodecahedron3D t3d13 = new Dodecahedron3D( 6, 0, 0, os, 45, 45, 0, blueMaterial);
...
//		dt.incrSequence();
		...
		Dodecahedron3D t3d21 = new Dodecahedron3D( 0, 6, 0, os, 0, 0, 0, blueMaterial);
		...
		zlab = 9;	
		for (int i = 0; i < 5; i++) {
			Dodecahedron3D t3d22 = new Dodecahedron3D( xloc, 0, 0, os, xr, 0, 0, blueMaterial);
		...
		zlab = 9;
		for (int i = 0; i < 5; i++) {
			Dodecahedron3D t3d23 = new Dodecahedron3D( xloc, 0, 0, os, 0, yr, 0, blueMaterial);
		...
		zlab = 9;
		for (int i = 0; i < 5; i++) {
			Dodecahedron3D t3d24 = new Dodecahedron3D( xloc, 0, 0, os, 0, 0, zr, blueMaterial);
		...
		initRotations();
		dt.drawPolyhedron3D(t3d21, true);
		Dodecahedron3D t3d25 = new Dodecahedron3D( 0, 0, 0, os, xr, yr, 0, blueMaterial);
		...
		dt.incrSequence();
		dt.drawPolyhedron3D(t3d21, true);
		Dodecahedron3D t3d26 = new Dodecahedron3D( 0, 0, 0, os, xr, 0, zr, blueMaterial);
		...
		dt.incrSequence();
		dt.drawPolyhedron3D(t3d21, true);
		Dodecahedron3D t3d27 = new Dodecahedron3D( 0, 0, 0, os, 0, yr, zr, blueMaterial);
		t3d27.setDrawMode(DrawMode.FILL);
		dt.drawPolyhedron3D(t3d27, true);
		dt.drawLabel(6, 10, 0, "Y=" + yr + ", Z=" + zr + " rotation");
		
		dt.incrSequence();
		Dodecahedron3D t3d28 = new Dodecahedron3D( -6, -6, 0, os, xr, 0, 0, blueMaterial);
		t3d28.setDrawMode(DrawMode.FILL);
		dt.drawPolyhedron3D(t3d28, true);
		Dodecahedron3D t3d29 = new Dodecahedron3D( 0, -6, 0, os, 0, yr, 0, blueMaterial);
		t3d29.setDrawMode(DrawMode.FILL);
		dt.drawPolyhedron3D(t3d29, true);
		Dodecahedron3D t3d30 = new Dodecahedron3D( 6, -6, 0, os, 0, 0, zr, blueMaterial);
		t3d30.setDrawMode(DrawMode.FILL);
		dt.drawPolyhedron3D(t3d30, true);
		
		Dodecahedron3D t3d32 = new Dodecahedron3D( 0, 6, 0, os, 0, 0, 0, blueMaterial);
		dt.drawPolyhedron3D(t3d32, true);
		Dodecahedron3D t3d31 = new Dodecahedron3D( 0, 0, 0, os, xr, yr, zr, blueMaterial);
...
/*
		...
		for (int i = 0; i < 100; i++) {
			...
			Dodecahedron3D dod3d = new Dodecahedron3D(ox, oy, oz, os, rx, ry, rz, blueMaterial);
