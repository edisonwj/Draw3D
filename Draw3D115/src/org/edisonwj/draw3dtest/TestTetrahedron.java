...
public class TestTetrahedron extends Application {
	...
	private void buildData() {
		...
		dt.setSequencingOn();
		t3d0.setDrawMode(DrawMode.FILL);
		t3d0.setMaterial(new PhongMaterial(Color.CYAN));
		dt.drawPolyhedron3D(t3d0, true);
		...
		dt.incrSequence();
		Tetrahedron3D t3dxx1 = new Tetrahedron3D(6, 0, 0, s, new PhongMaterial(Color.LIGHTBLUE));
